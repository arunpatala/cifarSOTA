...
parser.add_argument('--eval_freq', type=int, default=10, metavar='N', help='evaluation frequency (default: 10)')
...
ret = transforms.RandomErasing(probability = args.p, sh = args.sh, r1 = args.r1, )
#model_cfg.transform_train.transforms.append(ret)
...
for epoch in range(start_epoch, args.epochs):
    ...
    train_res = utils.train(loaders['train'], model, criterion, optimizer, alpha=args.alpha, ret=ret)
    ...
    #print(epoch + 1, lr, train_res['loss'], train_res['accuracy'])
    #print(test_res['loss'], test_res['accuracy'], time_ep)
